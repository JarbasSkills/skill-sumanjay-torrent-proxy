# <img src='./ui/logo.png' width='50' height='50' style='vertical-align:bottom'/>Sumanjay Torrents Skill

Sumanjay Torrents OCP peerflix Skill

You need to also install [skill-peerflix](https://github.com/JarbasSkills/skill-peerflix) for actual playback!

## About

search and stream [Sumanjay Torrent](https://api.sumanjay.cf/torrent/) api by voice!

![](./gui.png)

## Examples

* "play the lord of the rings return of the king extended edition"
